...
namespace proje_deneme1
{
    public partial class form2 : Form
    {
        ...
        private void kullanicilari_göster()
        {
            ...
            {
                MessageBox.Show(hatamsj.Message, " PERSONEL TAKİP PROGRAMI", MessageBoxButtons.OK, MessageBoxIcon.Error);
                baglantim.Close();
        ...
        private void personelleri_göster()
        {
            try
            {
                ...
                OleDbCommand sorgu = new OleDbCommand("SELECT * FROM personeller", baglantim);
        ...
        private void form2_Load(object sender, EventArgs e)
        {
            ...
            comboBox1.Items.Add("İlköğretim"); comboBox1.Items.Add("ortaöğretim"); comboBox1.Items.Add("Lise"); comboBox1.Items.Add("Üniversite"); //işçi liseye kadar memur üniye kadar if bloğu getir

            
            comboBox3.Items.Add("Arge"); comboBox3.Items.Add("Bilgi İşlem"); comboBox3.Items.Add("Muhasebe"); comboBox3.Items.Add("üretim"); comboBox3.Items.Add("Paketleme"); comboBox3.Items.Add("Nakliye");
        ...
        private void textBox5_TextChanged(object sender, EventArgs e)
        {
            ...
            if (kucuk_harf_skoru == 0 || buyuk_harf_skoru == 0 || rakam_skoru == 0 || sembol_skoru == 0)
                label22.Text = "Büyük harf,küçük harf, sembol ve rakam kullanın!";
            if (kucuk_harf_skoru != 0 && buyuk_harf_skoru != 0 && rakam_skoru != 0 && sembol_skoru != 0)
                label22.Text = "";
        ...
        {
            pictureBox2.Image = null; maskedTextBox1.Clear(); maskedTextBox2.Clear(); maskedTextBox3.Clear();  comboBox1.SelectedIndex = -1; comboBox3.SelectedIndex = -1;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Girilen tc kimlik numarası daha önceden kayıtlıdır!", " personel takip prgoramı", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lutfen 11 haneli tc kimlik no giriniz!", " personel takip prgoramı", MessageBoxButtons.OK, MessageBoxIcon.Error);
                topPage1_temizle();
            }
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text.Length == 11 && textBox1.Text != "" && textBox2.Text != "" && textBox2.Text.Length > 1 && textBox3.Text != "" && textBox3.Text.Length > 1 && textBox4.Text != "" && textBox5.Text != "" && textBox6.Text != "" && textBox5.Text == textBox6.Text && parola_skoru >= 70)
            {
                ...
                {
                    MessageBox.Show(hatamsj.Message, " perosnel takip programı", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    baglantim.Close();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (textBox1.Text.Length == 11)
            {
                ...
                if (kayit_arama_durumu == false)
                    MessageBox.Show("Silincek kayıt bulunamadı", " personel takip sistemi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                baglantim.Close();
                topPage1_temizle();
            }
            else
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            if (pictureBox2.Image != null && maskedTextBox1.MaskCompleted != false && maskedTextBox2.MaskCompleted != false && maskedTextBox3.MaskCompleted != false && comboBox1.Text != "" && comboBox3.Text != "")
            {
                ...
                try
                {
                    ...
                    baglantim.Open();
                    OleDbCommand eklekomutu = new OleDbCommand("INSERT INTO personeller (tcno, ad, soyad, cinsiyet, mezuniyet, dogumtarihi, gorevyeri) VALUES ('" + maskedTextBox1.Text + "','" + maskedTextBox2.Text + "','" + maskedTextBox3.Text + "','" + cinsiyet + "','" + comboBox1.Text + "','" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "','" + comboBox3.Text + "')", baglantim);
                    eklekomutu.ExecuteNonQuery();
                    baglantim.Close();
            ...
            {
                MessageBox.Show("Yazı rengi kırmızı olanları gözden geçiriniz.", "Personel Takip", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            if (maskedTextBox1.Text.Length == 11)
            {
                ...
                while (kayitokuma.Read())
                {
                    ...
                    {
                        pictureBox2.Image = Image.FromFile(Application.StartupPath + "\\personelresimler\\resimyok.jpg.jpg");
                    }
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            if (pictureBox2.Image != null && maskedTextBox1.MaskCompleted != false && maskedTextBox2.MaskCompleted != false && maskedTextBox3.MaskCompleted != false && comboBox1.Text != "" && comboBox3.Text != "")
            {
                ...
                try
                {
                    ...
                    OleDbCommand guncellekomutu = new OleDbCommand("UPDATE personeller SET ad = '" + maskedTextBox2.Text + "', soyad = '" + maskedTextBox3.Text + "', cinsiyet = '" + cinsiyet + "', mezuniyet = '" + comboBox1.Text + "', dogumtarihi = '" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "', gorevyeri = '" + comboBox3.Text + "' WHERE tcno = '" + maskedTextBox1.Text + "'", baglantim);
                    guncellekomutu.ExecuteNonQuery();
                    baglantim.Close();
                    ...
                    MessageBox.Show("Personel kaydı güncellendi", "Personel Takip Programı", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if (maskedTextBox1.MaskCompleted == true)
            {
                ...
                if (kayit_arama_durumu == false)
                {
                    MessageBox.Show("silinecek kayıt bulunamadı", " personel takip", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                baglantim.Close();
                personelleri_göster();
                topPage2_temizle();
            ...
            {
                MessageBox.Show("11 karakterden oluşan tcno girin", " personel takip", MessageBoxButtons.OK, MessageBoxIcon.Error);
                topPage2_temizle();
        ...
        private void label11_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (kayitOkuma.Read())
                {
                    ...
                    {
                        MessageBox.Show("Yönetici veya Manager departmanına ait kullanıcı bulunamadı.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                else
                {
